...
The following lesson is derived from work that is copyright &copy; Software Carpentry, available at http://swcarpentry.github.io/r-novice-gapminder/03-seeking-help/index.html licensed under a [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license. The use of this lesson in the present course is not formally endorsed by Software Carpentry. 

## Reading Help files

R, and every package, provide help files for functions. The general syntax to search for help on any function, "function_name", from a specific function that is in a package loaded into your
