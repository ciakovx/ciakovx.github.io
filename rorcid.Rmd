...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/ciakovx/ciakovx.github.io/master?filepath=rorcid.ipynb)

<https://mybinder.org/v2/gh/ciakovx/ciakovx.github.io/master?filepath=rorcid.ipynb>

Download a script for these files at:

* [rorcid.R](https://osf.io/kj72e)
* [rorcid_employments](https://osf.io/f5uke)
...
```{r employmentq1, eval=TRUE, cache=TRUE}
...
```{r employmentq2, eval=TRUE, cache=TRUE}
...
```{r employmentq3, eval=TRUE, cache=TRUE}
...
```{r employmentq4, eval=TRUE, cache=TRUE}
...
```{r employmentq5, eval=TRUE, cache=TRUE}
...
```{r employmentq6, eval=TRUE, cache=TRUE}
...
```{r employmentq7, eval=TRUE, cache=TRUE}
...
```{r employmentq8, eval=TRUE, cache=TRUE}
...
```{r employmentq9, eval=TRUE, cache=TRUE}
...
```{r employmentq10, eval=TRUE, cache=TRUE}
...
```{r employmentq11, eval=TRUE, cache=TRUE}
