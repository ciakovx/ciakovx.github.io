...
subtitle: "Introduction and Getting Set-Up"
...
This guide accompanies the first day of instruction for my course at the 2019 FORCE11 Scholarly Communications Institute: ["AM4 - Working with Scholarly Literature in R: Pulling, Wrangling, Cleaning, and Analyzing Structured Bibliographic Metadata."](https://www.force11.org/fsci/2019/course-abstracts#AM4) It provides basic introduction to R and instructions for getting set-up. 
...
The guide was created by Clarke Iakovakis in 2018 and updated in 2019 for my course at FSCI. I am the Scholarly Services Librarian at the Oklahoma State University Library. I began using R in 2013 out of curiosity. The only background in computer programming I had at the time was a class in high school on Visual Basic, and a sparse knowledge of XML, HTML and CSS picked up in library school. My bachelor's degree is in history, and I am currently finishing my master's in the same discipline. My level of data literacy was relatively low as well--for instance, I did not really know what CSV files were or how to work with them. In other words, my background is in the humanities--not math, not science, not statistics, not computer science, not computer programming. **You do not have to be a statistician or programmer to learn and use R!**
...
## Using this guide
I have created a set of guides to accompany the Powerpoint slides and the classroom instruction. The guides are intended for you to dig deeper into the content of the webinar, show examples of code in use, and also work through some general exercises.
