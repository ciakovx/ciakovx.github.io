---
title: "FSCI 2021: W25 Syllabus - Working with Scholarly Literature in R: Pulling, Wrangling, Cleaning, and Analyzing Structured Bibliographic Metadata."
author: "Clarke Iakovakis, Kay Bjornen, Megan Macken"
output: 
  html_document:
    df_print: paged
    toc: true
...
Hello everyone. we are looking forward to our session at [FSCI 2021](https://www.force11.org/fsci/2021) on ["W25 - Working with Scholarly Literature in R: Pulling, Wrangling, Cleaning, and Analyzing Structured Bibliographic Metadata."](https://www.force11.org/fsci/2021/course-list-abstracts#W25) 
...
**Instructors:**
* Clarke Iakovakis, Scholarly Services Librarian, Oklahoma State University, <https://experts.okstate.edu/clarke.iakovakis>
* Kay Bjornen, Research Data Initiatives Librarian, Oklahoma State University, <https://experts.okstate.edu/kay.bjornen>
* Megan Macken, Digital Scholarship Librarian, Oklahoma State University, <https://experts.okstate.edu/megan.macken>
...
See the course OSF for Zoom links: <https://osf.io/vpgbt>
Sched home: <https://sched.co/iON7>
...
* Watch the [Using Jupyter Notebooks video tutorial](https://www.youtube.com/watch?v=3EKe_4zU4B0) (25 min.)

![](https://www.youtube.com/watch?v=3EKe_4zU4B0){width="90%"}
...
* Watch the [R Basics video tutorial](https://www.youtube.com/watch?v=f1wkanaYhVA) (30 min.)

![](https://www.youtube.com/watch?v=f1wkanaYhVA){width="90%"}
...
Skim the Data Exploration webpage at <https://ciakovx.github.io/DataExploration.html>. 
* Watch the [Data Exploration video tutorial](https://youtu.be/O8q7fg1dFUU) (1 hour).
@[youtube](https://youtu.be/O8q7fg1dFUU)

![](https://youtu.be/O8q7fg1dFUU){width="90%"}
...
* Watch the [Exploring Data in Lists video tutorial](https://youtu.be/F57EorEYRMM) (40 mins.)

![](https://youtu.be/F57EorEYRMM){width="90%"}
...
* Watch the [`rcrossref` and `roadoi` video tutorial](https://youtu.be/dy-raTcj0no) (1.25 hrs).

![](https://youtu.be/dy-raTcj0no){width="90%"}
