...
* Skim the [Data Exploration](DataExploration.html) webpage.  Most of this content is covered in the R Basics Jupyter Notebook. 
* Watch the [Data Exploration video tutorial](https://osf.io/npk3e/) (1 hour).
...
**5. Using `rcrossref` & `roadoi`: 1.5 hours**
